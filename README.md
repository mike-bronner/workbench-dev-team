...
| Holmes review | Opus parent + four blind Sonnet lens sub-agents + adversarial skeptic per review (security findings: 3-agent red/blue/auditor panel instead); capped at $7 per run |
